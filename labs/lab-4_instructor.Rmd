---
title: "Lab 4: Probability Distributions - Instructor Version"
output: 
  html_document: 
    theme: cosmo
    toc: yes
...
binom_dist <- data.frame(x = seq(1, 100, 1)) %>% #for the x axis, number of heads that we want to get the probability for
