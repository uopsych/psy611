...
The function `qbinom()` essentially does the opp `pbinom`. Instead of taking a value and returning a probability of getting that value or less, it takes a probability and returns the value (or a value less than that value) needed to achieve the probability.
