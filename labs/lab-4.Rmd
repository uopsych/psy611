...
library(panoply)
>>>>>>> 8d9f60ce2ea623b432ce8d5423fe15e5907540bd
```
...
If we plot the probability distribution of the example above, two things are apparent: (1) the most probable outcome of flipping `100` coins is `50` `heads` and (2) there are additional outcomes that are, although less probable, also possible (e.g. 0 heads)
