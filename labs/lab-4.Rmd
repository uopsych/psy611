...
```{r}
pbinom(q = 100, size = 100, prob = 1/2)
...
```{r}
pbinom(q = 1, size = 2, prob = 1/2, lower.tail = TRUE)
...
draw_binomial(size = 100, prob = 0.5)
pbinom(q = 2, size = 100, prob = 0.50)
...
qbinom(p = .25, size = 100, prob = 0.5, lower.tail = FALSE)
...
```{r}
# your code here
qnorm(p = 0.51, mean = 100, sd = 10, lower.tail = FALSE)
