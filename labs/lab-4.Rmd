...
1. You are playing Dungeons and Dragons and, to you Dungeon Master's displeasure, you run immediately to the dragon that is meant to be encountered at the end of the campaign. Yo must roll `2` `20`-sided die. However, in order to slay the dragon, you must roll two `20`s. What is the the probability of getting this result?

```{r}
dbinom(x = 2, size = 2, 1/20)
```

1. Your dungeon master has a change of heart and she decides to take pity on you. She says, if you roll at least `1` `20` she will let you live. What is the probability of getting rolling more than `0` `20`s when rolling `2` dice?

```{r}
pbinom(q = 0, size = 2, 1/20, lower.tail = FALSE)
...
Has been buying a lottery ticket for the last 52 weeks. The probabiliy that they win the lottery is 1/10000. What is the probability that they win at least one?

```{r}
dbinom(100, size = 100, prob = 1 / 1000)
