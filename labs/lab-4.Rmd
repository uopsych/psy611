...
*With 100 coin flips, what number of heads or less is associated with a .50 probability?*
```{r}
...
*What if we wanted to know the value that has a 25% chance of occuring  ?*
```{r}
