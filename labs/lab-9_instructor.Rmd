...
You can also calculate the standard deviation of the difference of the means from the standard deviation of each group using the equation discussed in class:
...
sqrt(g1_sd^2 + g2_sd^2 - (2 * g_cor * (g1_sd * g2_sd)))
```
