...
2. Report and interpret you results using r code embedded in text.

Anxiety symptoms were significantly reduced between before and after treatment, `r apa_print(toutput)$full_result`. 

3. Create a table to display the descriptive statistics from this data.
