...
Go ahead and load `{rio}` and `{psych}`, as we are going to need functions from these packages throughout. 
...
Import the World Happiness data using the `rio` package and save it to an object called `world_happiness`. You can use the `import` function along with this url: https://github.com/uopsych/psy611/raw/master/labs/resources/lab2/world_happiness_2015.csv
