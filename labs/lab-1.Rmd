...
R has arithmetic commands for adding,
```{r}
10 + 5
```
subtracting,
...
10 / 5
```
and, even, exponentiating.
```{r}
10^5
```

Much like the *Texas Instruments TI-84 Plus Graphics Calculator*, you can use paranthesis to tell R what parts of the equation you want to be evaluated first. As shown below, `(10 + 5) * 2` and `10 + 5 * 2` do not result in the same value.
