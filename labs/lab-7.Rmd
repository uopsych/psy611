...
# FAQ
Sources: 
-[OSF Slide Decks](https://osf.io/t4p9g/){target="_blank"}
-[APS](https://www.psychologicalscience.org/observer/research-preregistration-101#.WD_Dz5K5Ll5){target="_blank"}
...
See [here](https://mfr.osf.io/render?url=https://osf.io/zwkqj/?action=download%26mode=render){target="_blank"} for a checklist of what to include when reporting the results of preregistered research.

See [here](https://mfr.osf.io/render?url=https://osf.io/3k7hf/?action=download%26mode=render){target="_blank"} for more info.

## 2. What if I need to change my research plan? [26:45]

## 3. Can't someone "scoop" my ideas?

* Date-stamped preregistrations make your claim verifable
...
* Basically, once you have written a pre-registration, you will have written most of the methods section. 
