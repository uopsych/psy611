...
Finally, I am using the `kableExtra::row_spec` function to highlight the 4th row `Premium` in yellow. There are so many more things that you can do with the kableExtra package. [Here](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html) is an excellent resource.
