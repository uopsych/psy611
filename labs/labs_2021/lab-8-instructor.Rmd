...
"Average cooperation (`r apa_print(t_output)$estimate`) was significantly less than 60, `r apa_print(toutput)$statistic`.
...
he example immediately below uses the `t.test()` function in the `{stats}` package to conduct the one-sample *t*-test of the difference scores.
