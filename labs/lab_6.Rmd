...
Okay, but when we are looking at our data histograms only get us so far. Usually we are interested in the relationship between at least two variables. 
...
I haven't mentioned this yet, but you can add multiple **geometric elements** to a single plot. Let's also add a regression line using `geom_smooth()`.
