...
|:-------|:-------|:-----------|:----------------------------|:------:|-------:|
| 1 | 09/30 | Introduction and overview | LSR Ch 1 & 3 |  |  |
|  | 10/02 | Research Methods | LSR CH 2 & 4, [Rothman et al. (2013)](readings/Rothman_2013.pdf), [The UX Researcher's Toolkit](https://maze.co/guides/ux-research/methods/?utm_source=chatgpt.com) |  |  |
|  | 10/03 | *Lab: Introduction to R*   |  |  |  |
| 2 | 10/07 | Latent variables and psychometrics | Podcast: [Quantitude, S1E09 -- Grumpy Old Man & Village Idiot Argue About Reliability](https://quantitudepod.org/episode-9-grumpy-old-man-village-idiot-argue-about-reliability/), [Bringmann et al., 2022](readings/bringmann_etal_2022.pdf), [Perrig et al., 2024](readings/perrig_2024.pdf) | Quiz 1 |  |
|  | 10/09 | Describing data | LSR Ch 5 & 6 |  |  |
|  | 10/10 | *Lab: R basics and descriptives* |  |  |  |
| 3 | 10/14 | Describing data | [Ozer & Funder (2019)](readings/Ozer_Funder_2019.pdf); [Calabro (2024)](https://substack.com/home/post/p-147494627) | Quiz 2 |  |
|  | 10/16 | Probability | LSR Intro to Part IV and Ch 9.1-9.3, [Wetzels et al. (2011)](readings/Wetzels_etal_2011.pdf) |  |  |
|  | 10/17 | *Lab: Functional programming* |  |  |  |
| 4 | 10/21 | Probability | LSR Ch 9.4 | Quiz 3 |  |
|  | 10/23 | Probability | LSR Ch 9.5-9.6 |  |  |
|  | 10/24 | *Lab: Probability distributions* |  |  | HW 1 Due |
| 5 | 10/28 | Sampling | LSR Ch 10 | Quiz 4 |  |
|  | 10/30 | Hypothesis testing | LSR Ch 11 |  |  |
|  | 10/31 | *Lab: Data wrangling* |  |  |  |
| 6 | 11/04 | Hypothesis testing | [Sainani (2012)](readings/Sainani_2012.pdf) | Quiz 5 |  |
|  | 11/06 | Critiques of hypothesis testing |  |  |  |
|  | 11/07 | *Lab: Graphing with ggplot2* |  |  |  |
| 7 | 11/11 | _Veterans Day - No Class_ |  |  |  |
|  | 11/13 | Critiques of hypothesis testing | [Simmons et al. (2011)](readings/Simmons_etal_2011.pdf), [Cumming (2014)](readings/Cumming_2014.pdf) | Quiz 6 |  |
|  | 11/14 | *Lab: RMarkdown* |  |  | HW 2 Due |
| 8 | 11/18 | Open Science | [Five Thirty Eight](https://fivethirtyeight.com/features/science-isnt-broken/), [Simmons, Nelson, & Simonshon, 2016 (blog)](https://datacolada.org/64) | Quiz 7 |  |
|  | 11/20 | One-sample tests | LSR Ch 13.1-13.2 |  |  |
|  | 11/21 | *Lab: One- and paired-samples t-tests* |  |  |  |
| 9 | 11/25 | Comparing two means (paired) | LSR Ch 13.3-13.11 | Quiz 8 |  |
|  | 11/27 | **Thanksgiving** |  |  |  |
|  | 11/28 | **Lab: No Lab** |  |  |  |
| 10 | 12/02 | Comparing two means (independent) |  |  |  |
|  | 12/04 | Effect sizes and assumptions |  | Quiz 9 |  |
|  | 12/05 | *Lab: Independent-samples t-tests* |  |  |  |
| Finals | 12/08 |  |  |  | HW 3 Due [^1] 9am |

[^1]: Final grades are due the following Tuesday, so there are limited opportunities to redo this particular assignment for points. I will do my best to grade these within 24 hours of receipt so you have a chance to retry any missed points. Consider Friday 12/12 at 9am PT the last possible time to submit this assignment.
...
## Journal entries (PSY students only)
...
The purpose of this assignment is to help facilitate communication between you and me. I have used this assignment since Spring 2020 and found it an excellent way to build relationships with students. This is especially important because I am your Director of Graduate Studies, and it helps me to know what is and is not working in the early days of our program.
...
While generative AI tools (such as ChatGPT, Claude, Gemini, and others) can be useful for assisting with certain tasks, it’s important to use these technologies responsibly and ethically.
...
**You may not use generative AI to help you with your homework assignments, with one exception.** Each assignment will have one 10-point question that helps you work through a problem collaboratively with generative AI. It is on this, and _only_ this question that you may use AI.
