...
- X is the number of successful trials over N independent trials, with the probability of success on any trial equal to q.

- q and N are parameters of the binomial distribution.
...
### Write on board
For example, the sequence of 5 independent rolls of a die: 
`3 6 6 1 6`

can be represented in binomial form in the following way if rolling a 6 is a success:
`Not6 6 6 Not6 6`
The probability of that particular sequence is then:
*$P(Not6)P(6)P(6)P(Not6)P(6)$ or
*$P(6)^3P(Not6)^2)$
*$(\frac{1}{6})^3(\frac{5}{6})^2$
...
But a specific sequence of indepenent outcomes is just one way we could have X successful trials out of N. 
...
$$\frac{5!}{3!(5-3)!} = \frac{5\times4\times3\times2\times1}{3\times2\times1(2\times1)}=10$$

Putting the pieces together:

$$P(X = \text{a }6, \text{three times}|\theta_6, N= 5)= \frac{5!}{3!(5-3)!}(\frac{1}{6})^3(\frac{5}{6})^2=.032$$
---
