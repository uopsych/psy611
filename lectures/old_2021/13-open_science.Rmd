...
.small[[Condon, Graham, Mroczek, 2018](https://psyarxiv.com/2fn5x/)]
...
- The original study $(N = 25)$ found a significant effect, $\bar{X} = 20$ (95% CI [5, 35]). 

- The second study $(N = 40)$ does not find a significant effect, $\bar{X} = 10$ (95% CI [-1, 21]). 

- Did the second study replicate the first?
...
- A _major_ challenge to both reproducibility and robust science is how opaque other peoples' data and analsyes are. 
