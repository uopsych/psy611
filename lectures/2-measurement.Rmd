...
Today, we'll discuss methodologial issues present in statistics. 
...
## Statistical conclusion valditiy

- **Definition:** the valdity of the inference that X and Y are related
...
### (Some) threats to statistical conlcusion validity
