...
* With the people around you, come up with 3 latent variables that you might be interested in and describe how you would measure them.
...
### Assumptions of (most) measurements

What assumptions do we make when we construct latent variables?

--

* What else do our items capture?

* Are all items weighted equally?

* Does the latent variable cause the items?

???

Use job success measure. How are items biased?
...
its teaching requirements. What is the typical class size?
