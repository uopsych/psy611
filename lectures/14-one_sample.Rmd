...
If we have nested models, we can calculate the difference in the two $\chi^2$ values and compare this to a new $\chi^2$ distribution with $p1-p2$ degrees of freedom.
