...
::::: columns
::: {.column width="50%"}
[Simple experiment: draw a marble from this jar.]{style="font-size:30px;"}

[What is the probability of drawing a blue and small marble?]{style="font-size:30px;"}
...
anim_save(here("lectures/images", "repeated_trials.gif"), plot)

```

![](images/repeated_trials.gif)
