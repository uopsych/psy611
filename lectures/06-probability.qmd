...
What is the probability of an Ace given that I drew a face card? 
...
Simple experiment: draw two cards from a standard 52 card deck.

What is the probability the first card is a diamond and the second card is red? 
...
What is the probability the first card is a diamond or the second card is red? 
