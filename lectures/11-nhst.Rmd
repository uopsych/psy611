...
- $H_0: \mu_{GAD} = \mu_{healthy}$ OR $H_0: \mu_{GAD} = 32$
- $H_1: \mu_{GAD} \neq \mu_{healthy}$ OR $H_0: \mu_{GAD} \neq 32$
...
Our _p_-value is larger than our $\alpha$ level, so we retain the null. 
---
...
We collect a sample and compare this to a null hypothesis: $H_0: \mu_0 = 100$. Holding our sample mean $(\bar{X} = 105)$ constant, how does our _p_-value change as our sample size gets larger?
