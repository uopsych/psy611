...
**Statistics in the news:** An [article](https://fivethirtyeight.com/features/how-the-two-party-system-obscures-the-complexity-of-black-americans-politics/) published this morning in _FiveThirtyEight_ on measuring political preferences of Black Americans.

.small[Jefferson, H. & Yan, A. (2020). How the two-party system obscures the complexity of Black Americans' politics. _FiveThirtyEight.com_]
---
...
```{r}
world = read.csv(here("data/world_happiness_2015.csv"))
world
```
...
quantile(world$Happiness, probs = .50)
quantile(world$Happiness, probs = c(.25, .75))
IQR(world$Happiness)
```
