...
.pull-left[
### Population
$$\small SP_{XY} =\Sigma(X_i−\mu_X)(Y_i−\mu_Y)$$
]
.pull-right[
### Sample
$$\small SP_{XY} =\Sigma(X_i−\bar{X})(Y_i−\bar{Y})$$
]
...
.small[Data source: [sapa-project.org](sapa-project.org), scales developed by [Condon (2017)](https://sapa-project.org/research/SPI/SPIdevelopment.pdf).]
