...
school %>%
  ...
  kable(., digits = 2, col.names = c("Issue", "OR Mean", "USA mean", "t value", "p value")) %>%
  kable_styling()
```
...
If the data are normally distributed, the sampling distribution of the mean will also be normally distributed.
...
More independent samples t-tests
