...
$$\text{Proportion}_{\text{Correct Peformance}} = .50$$
...
The likelihood of the puppy being successful 10 times out of 12 *if the true probability of success is .5* is `r round(dbinom(9,12,.5),2)`. That's pretty low! That's so low that we might begin to suspect that the true probability is not .5. 
