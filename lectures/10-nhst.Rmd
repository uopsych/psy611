...
University X has been around for 150 years, and so has 150 years worth of ratings of male applicants. You dig through all the old univeristy files and calculate the average rating of male applicants  (5.3 out of 10) and also the standard deviation of those ratings (3.3). 
...
$$Z = \frac{\bar{X}- M}{SD} = \frac{2.9-5.3}{1.03} = `r round(z, 2)`$$
...
And here's where we use the properties of the Standard Normal Distribution to calculate probabilites, specifically the probability of getting a score this far away from $\mu$ or more extreme:
