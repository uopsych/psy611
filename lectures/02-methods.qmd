...
Ex: Students do better on the first half of test compared to the second.
Ex: Students do better in the second half of the term compared to the first. 
...
- Internal validity is very important, but only when research has reached a specific stage. 

- External validity is of course valuable, and failing to meet external validity limits what we have learned. 

- But failing external validity does not mean a study is useless. 

---

- Moreover, efforts to secure external validity often come too early in the process of studying a phenomenon. 

- And, researchers often fail to ask what kinds of interactions do (or do not) matter when assessing external validity.

- Representativeness is a key example of external validity. Psychologists often wish to generalize their findings to all people in a population. Thus, there is pressure to recruit samples that are representative of those populations (e.g., age, gender, race, etc).

- How could this be flawed?
...
- What argument do Rothman and colleagues make in this paper?
- Why is representativeness problematic?
...
- Representativeness may or may not be useful.
